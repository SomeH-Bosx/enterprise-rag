...
class SessionModelOverrides:
    ...
    def from_mapping(cls, data: dict[str, Any] | None) -> "SessionModelOverrides":
        ...
        return cls(
            ...
            use_query_rewrite=_parse_optional_bool(data.get("use_query_rewrite")),
        )
    ...
    def has_any(self) -> bool:
        return bool(
            ...
            or self.use_query_rewrite is not None
        )
    ...
    def apply(self, base: Settings) -> Settings:
        ...
        if self.use_query_rewrite is not None:
            updates["use_query_rewrite"] = bool(self.use_query_rewrite)
        if not updates:
            return base
...
def defaults_from_settings(settings: Settings) -> dict[str, Any]:
    ...
    return {
        ...
        "use_query_rewrite": bool(settings.use_query_rewrite),
    }
